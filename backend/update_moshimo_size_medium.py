...
print("Switching to Medium size (s='m') to ensure content renders...")
...
res = supabase.table("products").update({"moshimo_html": meg_html}).eq("name", "MegRhythm Hinoki").execute()

print("Updated sizes to 'm' (Medium).")
